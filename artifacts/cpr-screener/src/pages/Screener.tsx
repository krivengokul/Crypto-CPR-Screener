      ...
      <div className="max-w-7xl px-4 py-8 min-h-screen flex flex-col">
        ...
        {currentStatus === "done" && (
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
              ...
              {(
                [
                  { key: "micro",  label: "pMicro",  range: "≤0.10%",         active: "border-[#7FFF00] text-[#7FFF00]" },
                  { key: "tiny",   label: "pTiny",   range: "0.10–0.22%",     active: "border-[#39FF14] text-[#39FF14]" },
                  ...
                  { key: "mega",   label: "pMega",   range: "5.00–10.00%",    active: "border-[#FC0FC0] text-[#FC0FC0]" },
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
              ...
              {(
                [
                  { key: "micro",   label: "Micro",   range: "≤0.10%",         active: "border-[#7FFF00] text-[#7FFF00]" },
                  { key: "tiny",    label: "Tiny",    range: "0.10–0.22%",     active: "border-[#39FF14] text-[#39FF14]" },
                  ...
                  { key: "mega",    label: "Mega",    range: "5.00–10.00%",    active: "border-[#FC0FC0] text-[#FC0FC0]" },

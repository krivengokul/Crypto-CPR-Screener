  ...
  return (
    <thead>
      <tr className="border-b border-border bg-muted/30">
        ...
        <th
          className="pl-8 pr-4 py-3 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider cursor-pointer hover:text-foreground min-w-[70px]"

      ...
      <TooltipProvider>
        <div className="flex min-h-screen bg-background">
          ...
          <main className="flex-1 overflow-auto min-w-0">
            ...
            {
              ["littleabove", "la-2tiny", "LA-PL12CL23", "la-allstepup", "littlebelow", "lb-2tiny", "lb-allstepdown", "1LB-PL12CL23", "LBALLD-U2<PU1",
               "HB-PU12CU23", "inside-cpr", "outside-cpr", "overlapping-higher", "overlapping-lower", "LBT-PU1>U1PL1>L1", "lower-bullish",
